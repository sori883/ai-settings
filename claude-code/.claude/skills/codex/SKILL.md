...
description: |
  ...
  使用場面: (1) 文言・メッセージの検討、(2) コードレビュー、(3) 設計の相談、(4) バグ調査、(5) 解消困難な問題の調査、(６) ドキュメントレビュー
---
...
### ドキュメントレビュー
codex exec --full-auto --sandbox read-only --cd /path/to/project "このプロジェクトのドキュメントをレビューして、改善点を指摘してください
